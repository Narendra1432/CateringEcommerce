...
$(document).ready(function () {
	...
	jQuery(".orange-bg").on('click', function () {
		jQuery(".logo-header img").attr("src", "images/HomePage/logo.png");
		jQuery(".footer-logo .text-center img").attr("src", "images/HomePage/logo.png");
		return false;
	});

	jQuery(".strong-blue-bg").on('click', function () {
		jQuery(".logo-header img").attr("src", "images/HomePage/logo2.png");
		jQuery(".footer-logo .text-center img").attr("src", "images/HomePage/logo2.png");
		return false;
	});

	jQuery(".moderate-green-bg").on('click', function () {
		jQuery(".logo-header img").attr("src", "images/HomePage/logo3.png");
		jQuery(".footer-logo .text-center img").attr("src", "images/HomePage/logo3.png");
		return false;
	});

	jQuery(".vivid-yellow-bg").on('click', function () {
		jQuery(".logo-header img").attr("src", "images/HomePage/logo4.png");
		jQuery(".footer-logo .text-center img").attr("src", "images/HomePage/logo4.png");
		return false;
	});
	...
	jQuery(document).ready(function () {
		$('#contact-form').submit(function () {
			...
			$("#message").slideUp(750, function () {
				$('#message').hide();
				$('#submit')
					.after('<img src="images/HomePage/ajax-loader.gif" class="loader" />')
